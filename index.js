...
// after the passport and just before the route we need to use the flash-connect
//bcuz this flash usses session-cookie so we need to send this after session cookie
// flash msg is set into the session cookie
app.use(flash());  
